import { Texture } from "src/FurnitureDesign/domain/entities/texture.entity";
import { TextureTypeorm } from "src/FurnitureDesign/infraestructure/persistence/typeorm/entities/texture.typeorm";
import { ColorRGBTypeorm } from "src/FurnitureDesign/infraestructure/persistence/typeorm/value-objects/color-rgb.typeorm";
