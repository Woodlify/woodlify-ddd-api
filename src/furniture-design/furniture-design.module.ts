...
import { EdgeTypeORM } from "./infraestructure/persistence/typeorm/entities/edge.typorm";
...
@Module({
    imports: [
        CqrsModule,
        TypeOrmModule.forFeature([CanvasTypeORM,FurnitureTypeORM,PieceTypeORM,TextureTypeORM,EdgeTypeORM]),
    ],
